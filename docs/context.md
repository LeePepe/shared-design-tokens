...
Its scope is `tokens/**`, `scripts/**`, `tests/**` (including explicitly pathed Swift tests), `ai/**`, `examples/data/**`, `dist/**`, `Sources/**`, `.github/**`, `package.json`, `package-lock.json`, `Package.swift`.
Support exclusions: `AGENTS.md`, `README.md`, `CHANGELOG.md`, `docs/**`, `specs/**`, `THIRD_PARTY_NOTICES.md`, `.gitignore` (documentation/metadata); `.build/**`, `node_modules/**`, `.swiftpm/**`, `*.tgz` (local artifacts).
