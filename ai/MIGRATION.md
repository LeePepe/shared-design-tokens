...
## Synthetic local adapter v0 to candidate.1
...
1. Pin private `0.1.0-candidate.1` by verified tarball, keeping the old fixture/config available. Preconditions: explicit light/dark, immutable synthetic identity keys and no unknown legacy roles.
